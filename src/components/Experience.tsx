...
export default function Experience({ experiences, resumeUrl }: ExperienceProps) {
  return (
    <section
      id="experience"
                  ...
                  <div>
                    <ul className="mt-2">
                      {exp.points.map((point, i) => (
                        <li key={i} className="relative before:content-['▹'] before:absolute before:left-0 before:text-[#64ffda] pl-7 mt-2 text-sm leading-normal">
                          {point}
                        </li>
                      ))}
                    </ul>
